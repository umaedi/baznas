...
<nav class="navbar navbar-expand-lg main-navbar container">
  ...
  <nav class="navbar navbar-light navbar-expand d-md-none d-lg-none d-xl-none position-fixed fixed-bottom" style="background-color: #fff">
    <ul class="navbar-nav nav-justified w-100">
      <li class="nav-item {{ Request::is('muzakki/dashboard') ? 'active' : '' }}">
        <a href="{{ route('muzakki.dashboard') }}" class="nav-link text-center">
      ...
      <li class="nav-item {{ Request::is('muzakki/zakat_pending') ? 'active' : '' }}">
        <a href="{{ route('muzakki.zakat.pending') }}" class="nav-link text-center">
      ...
      <li class="nav-item {{ Request::is('muzakki/riwayatzakat') ? 'active' : '' }}">
        <a href="{{ route('muzakki.riwayat.zakat') }}" class="nav-link text-center">
    ...
    <li class="nav-item">
      <a href="{{ route('muzakki.profile') }}" class="nav-link text-center">
